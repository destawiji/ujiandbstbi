<?php
    ...
    $nama_file = $_POST['nfile'];
    $query = "SELECT * FROM dokumen where nama_file = $nama_file";
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
          <a class="nav-link" href="https://unsibank.ac.id">
      ...
      <li class="nav-item">
        <a class="nav-link" href="stemmingIDN.php">
