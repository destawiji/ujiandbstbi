      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="text-center">
            ...
            <h1 class="font-weight-bold">Nama Kelompok :</h1>
            <br>
            <h3>Desta Wiji Pratama</h3>
            <h4 class="font-weight-bold">NIM 16.01.55.0002</h4>
            <hr>
            <h3>Okta Gunawan</h3>
            <h4 class="font-weight-bold">NIM 16.01.55.0005</h4>
            <hr>
            <h3>Bagas Luthfi A.R</h3>
            <h4 class="font-weight-bold">NIM 16.01.55.0088</h4>
            <hr>
